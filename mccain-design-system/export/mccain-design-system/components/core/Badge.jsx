...
const T = { success: { background: "var(--mc-success-soft)", color: "var(--mc-success-text)" }, indigo: { background: "var(--mc-indigo-tint)", color: "var(--text-accent)" }, neutral: { background: "var(--mc-surface)", color: "var(--mc-navy)", boxShadow: "inset 0 0 0 1px var(--mc-line)" }, dark: { background: "var(--mc-navy)", color: "#fff" } };
