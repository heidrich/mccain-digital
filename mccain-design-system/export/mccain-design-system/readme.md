...
- Dieses Projekt: `McCain Digital v2.dc.html` (Startseite + Modals + Konsole), `content.json` (Leistungsinhalte DE/EN), `McCain Digital Brand Guide v2.dc.html`, `McCain Digital Marke.dc.html`, `McCain Digital Logo.dc.html`, `McCain Digital Deck.dc.html`, `brand/` (alle Marken-Exporte)
