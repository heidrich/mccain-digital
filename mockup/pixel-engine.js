...
(function () {
  ...
  // mockup: accent re-tokened to the acid chartreuse of the redesign
  var ACC = "#DBFF00", PAPER = "#141412";
    ...
    function play() {
      ...
      function run() {
        ...
        function frame(t) {
          ...
          grad.addColorStop(0.82, "rgba(219,255,0,0.55)");
          grad.addColorStop(1, "rgba(219,255,0,0)");
          ctx.fillStyle = grad;
          ctx.beginPath();
