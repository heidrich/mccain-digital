...
(function () {
  ...
  function mount() {
    ...
    armNotes();
    armDevMode();
    /* For the workshop (/werkstatt/) and the gates (tools/verify_site.mjs,
     * tools/v5probe.mjs): the page's logic, the binder's counts, and the
     * template node behind an element. */
    window.__v5 = {
      logic,
      stats,
